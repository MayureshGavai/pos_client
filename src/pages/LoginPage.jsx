...
const LoginPage = () => {
  ...
  return (
    <div className='w-1/4 mx-auto mt-10 container border shadow-md border-black rounded-md font-Inter'>
            ...
            <h1 className='text-center text-2xl mt-2 uppercase font-semibold'>login</h1>
        <form onSubmit={handleSubmit(onSubmit)} autoComplete='off' className='mb-3 mx-3 p-2'>
            <div className='flex flex-col mb-4'>
                ...
                <input type="text" className='px-2 py-1 text-lg border rounded-md ' {...register('empId', {required: true})} />
        ...
        <div className='px-4 py-2'>
          ...
          <h1 className='w-1/2 mr-4'>Emp Id : <span className='font-bold'>1</span></h1>
          <h1 className='w-1/2 ml-4'>Password : <span className='font-bold'>test</span></h1>
          </div>
        </div>
      <ToastContainer />
